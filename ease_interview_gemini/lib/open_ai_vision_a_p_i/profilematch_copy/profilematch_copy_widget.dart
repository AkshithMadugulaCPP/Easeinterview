...
import 'profilematch_copy_model.dart';
export 'profilematch_copy_model.dart';

class ProfilematchCopyWidget extends StatefulWidget {
  const ProfilematchCopyWidget({
    super.key,
  ...
  @override
  State<ProfilematchCopyWidget> createState() => _ProfilematchCopyWidgetState();
}

class _ProfilematchCopyWidgetState extends State<ProfilematchCopyWidget>
    with TickerProviderStateMixin {
  late ProfilematchCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfilematchCopyModel());
                                              ...
                                              return Padding(
                                                ...
                                                child: wrapWithModel(
                                                  ...
                                                  child: SuggestioncardWidget(
                                                    key: Key(
                                                      'Key1ua_${suggestionsItem.toString()}',
                                                    ),
