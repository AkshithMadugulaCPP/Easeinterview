...
import 'coverletter_pending_model.dart';
export 'coverletter_pending_model.dart';

class CoverletterPendingWidget extends StatefulWidget {
  const CoverletterPendingWidget({
    super.key,
  ...
  @override
  State<CoverletterPendingWidget> createState() =>
      _CoverletterPendingWidgetState();
}

class _CoverletterPendingWidgetState extends State<CoverletterPendingWidget>
    with TickerProviderStateMixin {
  late CoverletterPendingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CoverletterPendingModel());
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Get AI Generated CoverLetter for your Resume.',
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                                    fontFamily: 'Inter',
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 4.0, 0.0, 0.0),
                                        child: Text(
                                          'Do you want to use existing resume or upload new one',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                                fontFamily: 'Inter',
